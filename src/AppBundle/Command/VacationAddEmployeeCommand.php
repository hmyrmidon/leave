...
//        $employee->setAddress($input->getArgument('address'));
        ...
        if ($input->getOption('create')) {
            ...
            $password   = crypt(implode("-", $input->getOption('create')))[2];

            $employee->setUsername($input->getOption('create')[0]);
            $employee->setEmail($input->getOption('create')[1]);
            $employee->setPassword($password);
            $employee->setLastName($input->getOption('create')[3]);
            $employee->setFirstName($input->getOption('create')[4]);
            $employee->setRegistrationNumber($input->getOption('create')[5]);
            $employee->setHiringDate($hiringDate);
            $employee->setMaritalStatus($input->getOption('create')[7]);
            $employee->setAddress($input->getOption('create')[8]);
